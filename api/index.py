...
def load_data():
    ...
    try:
        ...
        assignments_df = pd.read_csv(os.path.join(base_dir, "orientation_assignments_leader_assignments.csv"))
        events_df = pd.read_csv(os.path.join(base_dir, "orientation_assignments_event_staffing.csv"))
        summary_df = pd.read_csv(os.path.join(base_dir, "orientation_assignments_summary.csv"))
...
async def get_all_leaders():
    ...
    try:
        base_dir = os.path.dirname(current_dir)
        leaders_df = pd.read_csv(os.path.join(base_dir, "Trinity College Orientation Leaders 2025(Simplified).csv"))
